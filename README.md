...
```bash
pnpm test          # 單元 66 ＋ DB 整合 923 ＋ 端到端驗收 437，共 1,426 條
...
- [x] monorepo 骨架（§27 結構）＋ PostgreSQL 16＋46 份 migration（可從零重建）
...
tests/       unit（66）｜integration（DB 守衛 923 條）｜acceptance（端到端 437 條）｜fixtures/case-001
