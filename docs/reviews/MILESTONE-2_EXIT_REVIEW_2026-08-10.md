...
日期：2026-08-10｜基準：`46772ff`（**795/795** 全綠：單元 66／DB 整合 363／端到端 366；
...
> **2026-08-11 訂正**：端到端原記 364 條、總計 793，為加總誤計。逐套實測
> 27＋40＋89＋29＋33＋31＋64＋37＋16 ＝ **366**，總計 **795**。兩份測試檔自
> `46772ff` 起未變更，故該日實際即為 795；判定內容不受影響。
