...
7. `packages/domain/src/importBatch.ts`、九份 `packages/database/migrations/*.sql`、`packages/database/src/psql.ts`、API 與 Worker。
...
現有 9 份 migration；完整實跑結果為 **227/227**（單元 27、DB 整合 93、端到端 107）。
